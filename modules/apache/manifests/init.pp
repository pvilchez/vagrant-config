...
#
# [*listen_ports*]
#   An array of ports on which apache will listen.
#   This ports will be written to ports.conf.
#
# [*protocol*]
...
class apache (
  ...
  $ports_file          = params_lookup( 'ports_file' ),
  ...
  $listen_ports        = params_lookup( 'listen_ports' ),
